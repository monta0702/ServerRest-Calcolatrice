...
public class ServerRestV2 {
    ...
    public static void avviaServer(int porta) {
        try {
            ...
            server.createContext("/api/calcola/post", new PostHandlerV2());
            server.createContext("/api/calcola/get", new GetHandlerV2());
            ...
            System.out.println("  SOMMA, SOTTRAZIONE, MOLTIPLICAZIONE, DIVISIONE, POTENZA");
            System.out.println();
    ...
    private static void gestisciBenvenuto(HttpExchange exchange) throws IOException {
        ...
        operatori.put("radice","RADICE o V ");
